...
public class AlloySmelterResultSlot extends Slot {
    private final Player player;
    private int removeCount;

    public AlloySmelterResultSlot(final Player player, final Container container, final int slot, final int x, final int y) {
    ...
    protected void checkTakeAchievements(final ItemStack carried) {
        ...
        if (this.player instanceof ServerPlayer serverPlayer && this.container instanceof AbstractAlloySmelterBlockEntity abstractAlloySmelterBlockEntity) {
            abstractAlloySmelterBlockEntity.awardUsedRecipesAndPopExperience(serverPlayer);
        }
